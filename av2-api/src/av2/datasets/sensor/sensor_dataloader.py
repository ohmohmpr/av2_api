...
class SensorDataloader:
    ...
    def __post_init__(self) -> None:
        ...
        log_id                               sensor_name timestamp_ns
        0c6e62d7-bdfa-3061-8d3d-03b13aa21f68 lidar       315971436 059707000  315971436 049927217  ...  315971436 049927215
                                                         315971436 159903000  315971436 149927219  ...  315971436 149927217
                                                         315971436 260099000  315971436 249927221  ...  315971436 249927219
                                                         315971436 359632000  315971436 349927219  ...  315971436 349927221
                                                         315971436 459828000  315971436 449927218  ...  315971436 449927207
                                                         ...                 ...                 ...                 ...
        ff0dbfc5-8a7b-3a6e-8936-e5e812e45408 lidar       315972918 660124000  315972918 649927220  ...  315972918 649927214
                                                         315972918 759657000  315972918 749927214  ...  315972918 749927212
                                                         315972918 859853000  315972918 849927218  ...  315972918 849927213
                                                         315972918 960050000  315972918 949927220  ...  315972918 949927214
                                                         315972919 060249000  315972919 049927214  ...  315972919 049927212
        """
        # Load split, log_id, sensor_type, and timestamp_ns information.
        self.part_id = self.dataset_dir.stem
        self.sensor_cache = self._build_sensor_cache()
        # Populate synchronization database.
        if self.cam_names:
            synchronization_cache_path = (
                HOME / ".cache" / "av2" / self.part_id / "synchronization_cache.feather"
            )
    ...
    def _build_sensor_cache(self) -> pd.DataFrame:
        ...
        sensor_cache_path = HOME / ".cache" / "av2" / self.part_id/ "sensor_cache.feather"
    ...
    def _build_synchronization_cache(self) -> pd.DataFrame:
        ...
        print("sync_records", sync_records)
        return sync_records
